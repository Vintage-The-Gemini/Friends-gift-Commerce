...
import { Store, Package, BarChart2, Settings, LogOut, Menu, X, ShoppingBag, Home } from 'lucide-react';
...
const SellerLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white transform transition-transform duration-200 ease-in-out ${
