...
export const authStyles = {
  ...
  activeTab:
    "flex-1 text-center border-b-2 border-[#5551FF] pb-2 text-[#5551FF] font-medium",
  ...
  `,
  input:
    "w-full px-4 py-2 border rounded-lg focus:border-[#5551FF] focus:ring-1 focus:ring-[#5551FF] font-['Inter']",
  label: "block text-sm mb-1 font-['Inter']",
  button:
    "w-full bg-[#5551FF] text-white py-3 rounded-lg hover:bg-opacity-90 transition-colors font-medium",
