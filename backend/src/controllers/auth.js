...
// @access  Public
// backend/src/controllers/auth.js - Update the login function
...
exports.login = async (req, res) => {
  try {
    ...
    // Prepare query - if role is specified, add it to the query
    const query = { phoneNumber };
    if (role) {
      query.role = role;
    }

    // Check for user with the specified role if provided
    ...
    // For admin role, double-check that the user is actually an admin
